...
project <- "Bignon_JTK_RUV_nonrhythmic_run"

options(stringsAsFactors=FALSE)
annot <- read.delim("Bignon_JTK/Bignon_JTK_RUV_nonrhythmic_annot.txt")
data <- read.delim("Bignon_JTK/Bignon_JTK_RUV_nonrhythmic_data.txt")
