...
3. rnaseq command
    ...
    **but SORTMERNA doesn't work on my account, need to ask steve to help running it**
    **current version: no remove_ribo_rna**
    **need to add in UMI-based alignment for proper use**